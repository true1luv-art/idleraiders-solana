/**
 * server/solana-smart-contract/chain/solana/transfer.ts
 *
...
/** Converts a whole-token amount to base units using string math (no float precision loss). */
...
/**
 * Core payout: resolve ATAs, preflight treasury balance, build
 * transferChecked + memo instruction, send and confirm.
 */
