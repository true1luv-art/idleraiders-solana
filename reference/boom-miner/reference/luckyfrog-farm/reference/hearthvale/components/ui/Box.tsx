    ...
    >
      ...
      >
        {secondaryImage ? (
          <div className="w-full flex">
            <img src={typeof image === "string" ? image : image?.src} className="w-4/5 object-contain" alt="item" />

            <img
              src={typeof secondaryImage === "string" ? secondaryImage : secondaryImage?.src}
        ...
        {locked && (
          <img
            src={typeof cancel === "string" ? cancel : cancel?.src}
      ...
      {(isSelected || isHover) && !locked && !disabled && (
        <img
          ...
          src={typeof selectBox === "string" ? selectBox : selectBox?.src}
        />
      )}
    </div>
  );
