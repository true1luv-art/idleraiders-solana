...
export function LandscapeGate({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    const checkAll = () => {
      ...
      // Determine orientation — prefer the Screen Orientation API, fall back
      // to comparing inner dimensions.
    ...
    <>
      ...
      {isMobile && isPortrait && (
        ...
        >
          ...
          >
            Please rotate your<br />device to landscape<br />to play Hearthvale
          </p>
        </div>
      )}
    </>
