...
export function MobileActionButton() {
  ...
  // Re-detect mobile on resize (same pattern as MobileJoystick)
  useEffect(() => {
  ...
  return (
    <button
      ...
      style={{
        // Layout — fixed to viewport bottom-right, clear of joystick
        position:   "fixed",
        bottom:     "24px",
        right:      "16px",
        zIndex:     50,
        // Size — big enough for thumb
        width:      "56px",
        height:     "56px",
        // Visual — pixel-game style gold button with hard drop shadow
        display:        "flex",
        alignItems:     "center",
