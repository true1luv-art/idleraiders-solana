...
export const ScreenshotButton: React.FC = () => {
  ...
  const handleTweetClick = () => {
    window.open(
      "https://twitter.com/intent/tweet?text=Checkout%20my%20Hearthvale%20Farm%3A%0A%0A&ref_src=https%3A%2F%2Fhearthvale.com&hashtags=Hearthvale",
      "_blank"
    );
  };
  ...
  const handleSaveImage = () =>
    downloadImage(clearUrl(ssImg), "My VTC Farm", "jpeg");
  ...
  return (
    <div className="position-fixed flex bottom-44 p-1 right-2 w-10 z-50 cursor-pointer sm:w-12 md:w-18 lg:w-fit">
      <Button onClick={() => getScreenshot()} className="p-0">
        <img src={typeof screenshotIcon === "string" ? screenshotIcon : screenshotIcon?.src} className="w-fit" alt="screenshot" />
      </Button>
          ...
          <Modal.Body>
            <div className="flex justify-content-center">
              <div className="flex flex-wrap h-fit">
                <img
                  src={typeof ssImg === "string" ? ssImg : ssImg?.src}
                  id="ss-image"
