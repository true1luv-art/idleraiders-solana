...
import { getSkillLevel, getSkillXPForLevel, getSkillXPToNextLevel } from "@/features/game/skills";
import { INITIAL_SKILLS, type SkillCategory } from "@/features/types/gameplay/skills";
import { SectionLabel } from "@/components/ui/modal";

// Five gathering skills only — cooking removed.
...
export const SKILL_ORDER: SkillCategory[] = ["farming", "woodcutting", "mining", "fishing", "husbandry"];
