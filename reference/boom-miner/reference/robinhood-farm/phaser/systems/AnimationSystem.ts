...
// ── Config ────────────────────────────────────────────────────────────────────
// Human spr_ sprites: idle / walking / mining / axe / doing / casting / caught /
// waiting / reeling — each action has its own dedicated strip file.
...
const PLAYER_CONFIG = {
  ...
  WAITING: { key: 'player_waiting', texture: 'player_waiting', frames: { start: 0, end: 8  }, frameRate: 4,  repeat: -1 },
} as const

const FISHING_CONFIG = {
  CASTING: { key: 'player_casting', texture: 'player_casting', frames: { start: 0, end: 14 }, frameRate: 10, repeat: 0  },
  REELING: { key: 'player_reeling', texture: 'player_reeling', frames: { start: 0, end: 12 }, frameRate: 10, repeat: 0  },
