...
import { ChickenPosition, GameState } from "../types/game";
import { INITIAL_SKILLS, INITIAL_BONUS } from "../types/skills";
import { INITIAL_EQUIPMENT, INITIAL_BASE_STATS, computeStats } from "../types/equipment";

export const GRID_WIDTH_PX = 42;

// Time in milliseconds for animals to produce resources (1 minute for testing, adjust as needed)
...
// Fishing cooldown
/** Base cooldown at lv0 fishing skill (ms). */
export const FISHING_BASE_COOLDOWN_MS = 30_000; // 30 s
/** Minimum cooldown floor — reached at full fishSpeed bonus (ms). */
export const FISHING_MIN_COOLDOWN_MS  = 15_000; // 15 s

// Maximum number of animals a player can have
export const MAX_CHICKENS = 10;
export const MAX_COWS = 5;
export const MAX_SHEEP = 5;

// Positions for chickens near the barn
...
// Positions for cows near the barn
...
// Positions for sheep near the barn
